...
<script src="{{ asset('assets/admin/js/friendlink/friend_link.js') }}"></script>
...
@section('content')
        ...
        <button type="button" onClick="window.location.href='{{ action('Admin\FriendLinkController@create') }}';" class="btn btn-lg btn-success">新建</button>
        @endpermission
