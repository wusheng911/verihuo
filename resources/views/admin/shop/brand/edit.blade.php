...
@section('content')
            {!! Form::open(['url'=>action('Admin\Shop\BrandController@update',['id'=>$brand->id]),'method'=>'put']) !!}
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="form-group">
                                ...
                                <input id="newBrandName" type="text" class="col-lg-10 form-control-static" name="brand[name]" placeholder="请输入" value="{{$brand->name}}" >
                            </div>
                            <br>
                            <br>
                            <div class="form-group">
                                <label class="col-lg-2 control-label">品牌描述</label>
                                <textarea id="newBrandDescription" type="text" class="col-lg-10 form-control-static" name="brand[description]" placeholder="请输入" value="">{{$brand->description}}</textarea>
                            </div>
                            <br>
                            <br>
                            <div class="form-group" >
                                <label class="col-lg-2 control-label">logo</label>
                                @if(empty($brand->logo) || $brand->logo=='')
                                ...
                                @else
                                    <a href=""  class="popup_selector col-lg-10 form-control-static" data-inputid="feature_image_1"><img id="img_feature_image_1" style="width:150px;height:150px;" for="feature_image_1" alt="请选择品牌logo" src="{{$brand->logo}}"></a>
                                @endif
                                <input hidden type="text" id="feature_image_1" name="brand[logo]" value="{{$brand->logo}}"/>
                            </div>
                        </div>
                    </div>
