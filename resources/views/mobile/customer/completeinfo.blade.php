...
@section('navigatorTop')
    @include('mobile.elements.navigatorTop2', ['title' => '继续注册'])
@endsection
...
@if(!empty($err))
<div id="prompt_alert" data-alert="" class="alert-box warning" style="" data-item="">
    {{ $err['password'] or ''}}
    {{ $err['sms'] or '' }}
    {{ $err['sms_phone'] or '' }}
</div>
...
<form id="register_form" name="formCustomer" method="post" action="/wechat/register_step2" onsubmit="return mobile_register();">
    {!! csrf_field() !!}
    <div class="row collapse">
        ...
        <div class="small-6 columns">
            <input name="mobile_number" type="text"
                style="width:100%;" label="false" placeholder="请输入手机号码" value="{{ $u['mobile'] or '' }}"/>
        </div>
        <div class="small-2 columns">
    ...
    <div class="row collapse">
        ...
        <div class="small-6 columns">
            <input name="user_name" type="text" style="width:100%;" label="false" placeholder="请设置用户名" value="{{ $u['user_name'] or $user['nickname'] }}"/>              
        </div>
        <div class="small-2 columns">
    ...
    <div class="row collapse">
        ...
        <div class="small-8 columns">
            <input type="submit" style="width:100%;padding:10px 0;margin-bottom:0.5rem;" class="button" name="Submit" value="继续完成注册"/>
        </div>
...
@section('script-file-bottom')
    <script type="text/javascript" src="/assets/js/mobile.completeinfo.js"></script>
